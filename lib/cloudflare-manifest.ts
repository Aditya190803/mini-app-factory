...
export const cloudflareManifestSchema = z.object({
  ...
  bindings: z.object({
    ...
    r2: z.array(bindingWithName.extend({ jurisdiction: z.enum(['default', 'eu', 'fedramp']).optional() }).strict()).max(20).default([]),
...
export type CloudflareResourceKind = 'd1' | 'kv' | 'r2' | 'queue' | 'vectorize';
