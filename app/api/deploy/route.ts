...
export async function POST(req: Request) {
  ...
  try {
    ...
    const rawDescription = body.prompt ? body.prompt.slice(0, 200) : "Generated by Mini App Factory";
    ...
    if (!readmeExists) {
      const readme = `# ${body.projectName}\n\n${body.prompt ?? "Generated by Mini App Factory"}\n\n---\nMade by Mini App Factory`;
